...
if __name__ == "__main__":
    ...
    pcd1 = o3d.io.read_point_cloud("./test/little_cow.ply") # Read the point cloud
    ...
    pcd2 = o3d.io.read_point_cloud("./test/little_cow.ply") # Read the point cloud
    ...
    for a in range(0, len(noisy_points)):
        ...
        opt.pushResidual(name='pts' + str(a), params=['t'])
    # for a in range(0, 1):
