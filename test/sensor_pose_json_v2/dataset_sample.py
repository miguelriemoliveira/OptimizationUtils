...
if __name__ == "__main__":
    ...
    for i in range(0, 9):
        data_sample['collections'][str(i)] = {'data': {'frontal_camera': {'data_file': "", "height": 480, "width": 640},
                                              ...
                                              'transforms': {'car_center-frontal_camera': {'quat': [], 'trans': []},
    ...
    for c, c_key in data_sample['collections'].items():
        ...
        c_key['transforms']['car_center-frontal_camera']['quat'] = [0, 0, -0.7071, 0.7071]
        c_key['transforms']['car_center-frontal_camera']['trans'] = [0, 0, 0.85]
        c_key['transforms']['car_center-top_right_camera']['quat'] = [0.1405, 0.1405, -0.693, 0.693]
        c_key['transforms']['car_center-top_right_camera']['trans'] = [0, 1.5, 1.65]
        c_key['transforms']['frontal_camera-frontal_camera_optical']['quat'] = [-0.5, 0.5, -0.5, 0.5]
        c_key['transforms']['frontal_camera-frontal_camera_optical']['trans'] = [0, 0, 0]
        c_key['transforms']['top_right_camera-top_right_camera_optical']['quat'] = [-0.5, 0.5, -0.5, 0.5]
        c_key['transforms']['top_right_camera-top_right_camera_optical']['trans'] = [0, 0, 0]
        ...
        for sensor in ['frontal_camera', 'top_right_camera']:
            ...
            if found is True:
                print'\n encontrei xadrez na colecao:' + str(c) + '\n'
